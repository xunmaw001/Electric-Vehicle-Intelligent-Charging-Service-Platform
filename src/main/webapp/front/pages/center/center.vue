<template>
	<view class="content">
		<view @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}" :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"52rpx auto 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(204, 170, 143, 1)","borderRadius":"0 0 20rpx 20rpx","borderWidth":"0","width":"95%","borderStyle":"solid","height":"300rpx"}'>
			...
			<view :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"20rpx 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"16rpx","borderWidth":"0","width":"calc(100% - 112rpx)","borderStyle":"solid","height":"160rpx"}'v-if="tableName=='yonghu'" class="userinfo">
				<view class="face" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 20rpx 0 0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"100%","borderWidth":"0","width":"100rpx","borderStyle":"solid","height":"100rpx"}'>
					<image :src="user.xiangpian?baseUrl+user.xiangpian:'/static/center/face.jpeg'"></image>
				</view>
				<view class="info">
					<view class="username" :style='{"padding":"0 24rpx","boxShadow":"0 0 16rpx rgba(255,255,255,0)","margin":"12rpx 0","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(255,255,255,.3)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"48rpx","borderWidth":"0","width":"300rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.zhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
				</view>
			</view>
			<view class="setting">
		...
		<view class="list" :style='{"padding":"0 24rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"24rpx auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","borderRadius":"20rpx","borderWidth":"0","width":"96%","borderStyle":"solid","height":"auto"}'>
				...
				<block v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
					<block v-bind:key="sort" v-for=" (child,sort) in menu.child">
						<view :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","backgroundColor":"#fff","borderColor":"rgba(235, 235, 235, 1)","borderRadius":"0","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"solid","height":"80rpx"}' v-if="child.tableName!='yifahuodingdan' && child.tableName!='yituikuandingdan' &&child.tableName!='yiquxiaodingdan' && child.tableName!='weizhifudingdan' && child.tableName!='yizhifudingdan' && child.tableName!='yiwanchengdingdan' && child.tableName!='exampaper' && child.tableName!='examquestion' " @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li" hover-class="hover">
							<view v-if="true" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"#fff","color":"rgba(246, 185, 63, 1)","isShow":true,"borderRadius":"0","borderWidth":"0","width":"64rpx","lineHeight":"64rpx","fontSize":"52rpx","borderStyle":"solid"}' :class="child.appFrontIcon"></view>
...
<style lang="scss">
	...
	.content:after {
		...
		bottom: 0;
		content: '';
		background-image: url(http://codegen.caihongy.cn/20220215/7e95de72161f4ef3b776facf045f3385.png);
