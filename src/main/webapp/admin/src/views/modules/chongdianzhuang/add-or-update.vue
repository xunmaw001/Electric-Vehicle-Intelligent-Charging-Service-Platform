<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="输入电压" prop="shurudianya">
          <el-input v-model="ruleForm.shurudianya" 
              placeholder="输入电压" clearable  :readonly="ro.shurudianya"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="输入电压" prop="shurudianya">
              <el-input v-model="ruleForm.shurudianya" 
                placeholder="输入电压" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="输出功率" prop="shuchugonglv">
          <el-input v-model="ruleForm.shuchugonglv" 
              placeholder="输出功率" clearable  :readonly="ro.shuchugonglv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="输出功率" prop="shuchugonglv">
              <el-input v-model="ruleForm.shuchugonglv" 
                placeholder="输出功率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所处位置" prop="suochuweizhi">
          <el-input v-model="ruleForm.suochuweizhi" 
              placeholder="所处位置" clearable  :readonly="ro.suochuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所处位置" prop="suochuweizhi">
              <el-input v-model="ruleForm.suochuweizhi" 
                placeholder="所处位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="每时单价" prop="meishidanjia">
          <el-input v-model="ruleForm.meishidanjia" 
              placeholder="每时单价" clearable  :readonly="ro.meishidanjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="每时单价" prop="meishidanjia">
              <el-input v-model="ruleForm.meishidanjia" 
                placeholder="每时单价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	meishidanjia : false,
      ...
      rules: {
          ...
          meishidanjia: [
                { required: true, message: '每时单价不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuyishixiang = true;
          ...
          if(o=='suochuweizhi'){
            this.ruleForm.suochuweizhi = obj[o];
	    this.ro.suochuweizhi = true;
            continue;
          }
          if(o=='meishidanjia'){
            this.ruleForm.meishidanjia = obj[o];
	    this.ro.meishidanjia = true;
            continue;
          }
        }
      }
