<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="充值备注" prop="chongzhibeizhu">
          <el-input v-model="ruleForm.chongzhibeizhu" 
              placeholder="充值备注" clearable  :readonly="ro.chongzhibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="充值备注" prop="chongzhibeizhu">
              <el-input v-model="ruleForm.chongzhibeizhu" 
                placeholder="充值备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.jine = parseFloat(objcross.jine) + parseFloat(this.ruleForm.jine)
                }
	      this.$http({
		  url: `${table}/update`,
		  method: "post",
