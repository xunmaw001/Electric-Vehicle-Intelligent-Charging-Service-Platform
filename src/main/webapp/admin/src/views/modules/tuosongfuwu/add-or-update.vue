<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.fuwufengmian" label="服务封面" prop="fuwufengmian">
          <file-upload
          tip="点击上传服务封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fuwufengmian" label="服务封面" prop="fuwufengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fuwufengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务范围" prop="fuwufanwei">
          <el-input v-model="ruleForm.fuwufanwei" 
              placeholder="服务范围" clearable  :readonly="ro.fuwufanwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务范围" prop="fuwufanwei">
              <el-input v-model="ruleForm.fuwufanwei" 
                placeholder="服务范围" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="服务内容" prop="fuwuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuwuneirong" label="服务内容" prop="fuwuneirong">
                    <span v-html="ruleForm.fuwuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fuwuneirong = this.ruleForm.fuwuneirong.replace(reg,'../../../ssml3h97/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuosongfuwu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuosongfuwuCrossAddOrUpdateFlag = false;
						 this.parent.search();
