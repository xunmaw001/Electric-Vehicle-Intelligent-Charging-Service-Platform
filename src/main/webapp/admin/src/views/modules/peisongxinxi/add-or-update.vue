<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电池型号" prop="dianchixinghao">
          <el-input v-model="ruleForm.dianchixinghao" 
              placeholder="电池型号" clearable  :readonly="ro.dianchixinghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电池型号" prop="dianchixinghao">
              <el-input v-model="ruleForm.dianchixinghao" 
                placeholder="电池型号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.dianchifengmian" label="电池封面" prop="dianchifengmian">
          <file-upload
          tip="点击上传电池封面"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.dianchifengmian?ruleForm.dianchifengmian:''"
          @change="dianchifengmianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.dianchifengmian" label="电池封面" prop="dianchifengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.dianchifengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电池容量" prop="dianchirongliang">
          <el-input v-model="ruleForm.dianchirongliang" 
              placeholder="电池容量" clearable  :readonly="ro.dianchirongliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电池容量" prop="dianchirongliang">
              <el-input v-model="ruleForm.dianchirongliang" 
                placeholder="电池容量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单价" prop="danjia">
          <el-input v-model="ruleForm.danjia" 
              placeholder="单价" clearable  :readonly="ro.danjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单价" prop="danjia">
              <el-input v-model="ruleForm.danjia" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="下单时间" prop="xiadanshijian">
          <el-input v-model="ruleForm.xiadanshijian" 
              placeholder="下单时间" clearable  :readonly="ro.xiadanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="下单时间" prop="xiadanshijian">
              <el-input v-model="ruleForm.xiadanshijian" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物流状态" prop="wuliuzhuangtai">
          <el-select :disabled="ro.wuliuzhuangtai" v-model="ruleForm.wuliuzhuangtai" placeholder="请选择物流状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="物流状态" prop="wuliuzhuangtai">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="物流详情" prop="wuliuxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="物流详情"
                  v-model="ruleForm.wuliuxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wuliuxiangqing" label="物流详情" prop="wuliuxiangqing">
                    <span>{{ruleForm.wuliuxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.dianchifengmian!=null) {
		this.ruleForm.dianchifengmian = this.ruleForm.dianchifengmian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `peisongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.peisongxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    dianchifengmianUploadChange(fileUrls) {
	this.ruleForm.dianchifengmian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
