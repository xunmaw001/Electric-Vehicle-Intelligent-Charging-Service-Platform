...
public class ChongzhixinxiModel  implements Serializable {
	...
	public void setChongzhibeizhu(String chongzhibeizhu) {
		this.chongzhibeizhu = chongzhibeizhu;
	}
	
	/**
	 * 获取：充值备注
	 */
	public String getChongzhibeizhu() {
		return chongzhibeizhu;
	}
